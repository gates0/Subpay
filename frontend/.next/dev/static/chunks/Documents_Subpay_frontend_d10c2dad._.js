        ...
        queryFn: {
            "useFeedContent.useQuery": async ()=>{
                ...
                const results = await Promise.all(activeHubIds.map({
                    "useFeedContent.useQuery": (hubId)=>__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Subpay$2f$frontend$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(`/api/v1/hubs/${hubId}/content`)
...
function FeedPage() {
    ...
    const { data: subscriptions = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Subpay$2f$frontend$2f$hooks$2f$useSubscriptions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMySubscriptions"])();
...
_s2(FeedPage, "lZRCd2h5T10qFNewmva9hmKigLQ=", false, function() {
    return [
...
//# sourceMappingURL=Documents_Subpay_frontend_d10c2dad._.js.map