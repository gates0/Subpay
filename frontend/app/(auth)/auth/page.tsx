...
async function apiGoogleAuth(): Promise<{ ok: boolean; error?: string }> {
      ...
      <div className="w-full lg:w-[480px] xl:w-[520px] shrink-0 bg-#F5F3FF flex flex-col justify-center px-18 py-5 overflow-y-auto">
        ...
        <div className="bg-white rounded-3xl overflow-hidden" style={{ boxShadow: "0 8px 40px rgba(0,0,0,0.25), 0 0 0 1px rgba(255,255,255,0.1)" }}>
          ...
          <div className="px-8 py-7">
            {tab === "register"
              ? <RegisterForm role={role} setRole={setRole} onSuccess={handleSuccess} />
...
function RegisterForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      {error && (
        <p className="text-[12.5px] text-red-500 bg-red-50 border border-red-100 rounded-xl px-4 py-2.5">
          {error}
        </p>
      )}
