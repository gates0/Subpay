            ...
            <div className="flex items-end justify-between mb-6">
              ...
              <div className="flex bg-white border border-[#EBEBEB] rounded-xl overflow-hidden">
                {(["grid", "list"] as const).map(v => (
                  ...
                  >
                    {v === "grid"
                      ? <svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="1" y="1" width="4.5" height="4.5" rx="1"/><rect x="7.5" y="1" width="4.5" height="4.5" rx="1"/><rect x="1" y="7.5" width="4.5" height="4.5" rx="1"/><rect x="7.5" y="7.5" width="4.5" height="4.5" rx="1"/></svg>
                      : <svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M1 3h11M1 6.5h11M1 10h11" strokeLinecap="round"/></svg>
                    }
                  </button>
                ))}
              </div>
