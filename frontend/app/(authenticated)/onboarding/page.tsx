...
import { useCompleteOnboarding, useCheckUsername } from "@/hooks/useOnboarding"
...
export default function OnboardingPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await complete.mutateAsync({ username, role })
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <p
            ...
            style={{ fontSize: "clamp(13px, 1vw, 15px)", color: "#6B7280" }}
          >
          ...
          <div className="px-8 pt-8 pb-6 flex flex-col gap-6">
            ...
            <div>
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "border-[#6C36F5] bg-[#F5F3FF]"
                          : "border-[#F3F4F6] bg-white hover:border-[#DDD6FE]"
                      )}
                    >
                      {/* Icon */}
                      <div
                      ...
                      <div>
                        <p
                          ...
                          style={{ fontSize: "13px", color: isActive ? "#6C36F5" : "#111827" }}
                        >
                          {r}
                        </p>
              ...
              {role === "creator" && (
                ...
                >
                  A hub will be created for you automatically. You can always upgrade from member to creator later, but not the other way around.
                </p>
              )}
            </div>
